-- ============================================================================
-- LOKACIJE — pregled delova po lokacijama (RPC za tabelu + paginacija)
-- ============================================================================
-- Zavisi od: loc_* migracija, bigtehn_work_orders_cache, opciono
--   projekt_bigtehn_rn + projects (za kolone predmeta). Ako projekt_* ne
--   postoje, primeni add_sastanci_module.sql pre ovoga.
--
-- PostgREST: POST /rest/v1/rpc/loc_report_parts_by_locations
--   body: { "p_drawing_no": "...", "p_order_no": "...", ... }
--
-- Idempotentno.
-- ============================================================================
