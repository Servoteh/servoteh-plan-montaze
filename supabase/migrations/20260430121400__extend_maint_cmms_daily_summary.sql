-- Supabase: isti sadržaj kao sql/migrations/extend_maint_cmms_daily_summary.sql

-- ============================================================================
-- ODRŽAVANJE (CMMS) — proširenje v_maint_cmms_daily_summary (P1/P2, kasni WO)
-- ============================================================================
-- MORA posle: add_maint_daily_ops_view.sql
-- ============================================================================
