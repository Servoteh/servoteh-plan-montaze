...
export async function loadCurrentSalariesFromDb() {
  ...
  return data.map(d => ({
    ...
    perDiemRsd: d.per_diem_rsd == null ? 0 : Number(d.per_diem_rsd),
    perDiemEur: d.per_diem_eur == null ? 0 : Number(d.per_diem_eur),
    fixedAmount: d.fixed_amount == null ? 0 : Number(d.fixed_amount),
    fixedTransportComponent: d.fixed_transport_component == null ? 0 : Number(d.fixed_transport_component),
    fixedExtraHourRate: d.fixed_extra_hour_rate == null ? 0 : Number(d.fixed_extra_hour_rate),
    firstPartAmount: d.first_part_amount == null ? 0 : Number(d.first_part_amount),
    splitHourRate: d.split_hour_rate == null ? 0 : Number(d.split_hour_rate),
    splitTransportAmount: d.split_transport_amount == null ? 0 : Number(d.split_transport_amount),
    hourlyTransportAmount: d.hourly_transport_amount == null ? 0 : Number(d.hourly_transport_amount),
    terrainDomesticRate: d.terrain_domestic_rate == null ? 0 : Number(d.terrain_domestic_rate),
    terrainForeignRate: d.terrain_foreign_rate == null ? 0 : Number(d.terrain_foreign_rate),
    contractRef: d.contract_ref || '',
    note: d.note || '',
